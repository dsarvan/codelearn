 ...
 * Adding a masked pragma to print output
*/
...
int main(int argc, char *argv[]) {
	...
	#pragma omp parallel /* Spawn threads */
	{
		...
		#pragma omp master /* directive to run only on main thread */
		{
			/* Places output statements into an OpenMP masked pragma block */
